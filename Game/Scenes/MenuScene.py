...
class MenuScene(Scene):
    ...
    def __init__(self, game):
        ...
        self.addText("F1 - Start a new game", x = 300, y = 200, size = 30)
        self.addText("F2 - Highscores board", x = 300, y = 240, size = 30)
        self.addText("F3 - Quit", x = 300, y = 280, size = 30)

        self.__menuSprite = pygame.image.load(GameConstants.SPRITE_MENU)
        
    def render(self):
        # (what to render, (pos_x, pos_y))
    ...
    def handleEvents(self, events):
        ...
        for event in events:
            # event QUIT happens when the user clicks the close window button
